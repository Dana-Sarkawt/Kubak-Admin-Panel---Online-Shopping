export namespace Environment {
    ...
    // Appwrite Database
    export const appwrite_database: string = ENVIRONMENT.VITE_APPWRITE_DATABASE_ID;

    // Appwrite Collections
    export const appwrite_collection_card: string = ENVIRONMENT.VITE_APPWRITE_CARD_ID;
    export const appwrite_collection_category: string =
        ENVIRONMENT.VITE_APPWRITE_CATEGORY_ID;
    export const appwrite_collection_item: string = ENVIRONMENT.VITE_APPWRITE_ITEM_ID;
