...
<!-- <div class="container mx-auto px-12 mt-12">
  ...
  <Table shadow>
    ...
    <div class="h-52 container mx-auto w-full flex justify-center items-center text-center text-white">
      <p class="w-full flex text-center justify-center">No Data Found</p>
          </div>
</div> -->